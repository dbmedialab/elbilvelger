...
const Footer = _emotion_styled__WEBPACK_IMPORTED_MODULE_6___default.a.footer`
    position: fixed;
    display: flex;
    width: 100vw;
    ...
    background: #fff;        
`;
const Footerinner = _emotion_styled__WEBPACK_IMPORTED_MODULE_6___default.a.div`
    display: flex;
    flex-direction: row;
...
class FlexWrapper extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  render() {
    return __jsx("div", {
