...
function (_React$Component) {
  ...
  function Car(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "sortByRange", function (orderBy) {
      ...
      console.log('orderBy:', _this.state.orderBy);
      elbilerCopy.sort(function (a, b) {
        return a.rekkevidde - b.rekkevidde;
      });

      if (_this.state.orderBy === "desc") {
        elbilerCopy.reverse();
      }
    ...
    value: function render() {
      ...
      return __jsx(FlexWrapper, {
        ...
        onClick: function onClick() {
          _this2.setState({
            orderBy: _this2.state.orderBy === 'asc' ? 'desc' : 'asc'
          }, function () {
            _this2.sortByRange();
          });
        },
...
//# sourceMappingURL=index.js.84a9fa5e7eb955f9a4ff.hot-update.js.map