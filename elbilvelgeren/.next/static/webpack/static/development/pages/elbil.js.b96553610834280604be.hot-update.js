...
function ElbilDetail() {
  ...
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])([_elbiler_json__WEBPACK_IMPORTED_MODULE_7__]),
      elbil = _useState[0],
      setElbil = _useState[1];
  ...
  var singleElbil = _elbiler_json__WEBPACK_IMPORTED_MODULE_7__.filter(function (elbil) {
    return elbil.id === elbilId;
  });
  console.log(_elbiler_json__WEBPACK_IMPORTED_MODULE_7__.filter(function (elbil) {
    return elbil.id === elbilId;
  }));

  var elBiler = __jsx(react_reveal_Fade__WEBPACK_IMPORTED_MODULE_8___default.a, {
    __source: {
...
//# sourceMappingURL=elbil.js.b96553610834280604be.hot-update.js.map