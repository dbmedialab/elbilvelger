...
function () {
  ...
  _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee(_ref) {
    var req, query, url, parameter, elbilId;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            elbilId = Number(query.id); // Returning elbilId to the id from Params
...
function ElbilDetail(_ref3) {
  ...
  console.log("her kommer elbilid" + elbilId); // Using effect to 
  ...
  console.log("hei"); // Filtering out the car that matches the elbilId
...
//# sourceMappingURL=elbil.js.deb7173f468210a4a662.hot-update.js.map