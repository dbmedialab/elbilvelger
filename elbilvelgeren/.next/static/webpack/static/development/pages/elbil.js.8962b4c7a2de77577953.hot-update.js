...
function ElbilDetail(_ref3) {
  ...
  var aksingLabrador = new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_1___default.a(function (resolve, reject) {
    setTimeout(function () {
      resolve('foo');
    }, 300);
  });
  aksingLabrador.then(function (value) {
    var marius = _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(data);

    console.log(marius); // expected output: "foo"
  });
  console.log(aksingLabrador); // expected output: [object Promise]
  // Lage en sporring som cathcer error

  var marius = _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(data);

  console.log(_apollo_react_hooks__WEBPACK_IMPORTED_MODULE_12__["useQuery"]); // Filtering out the car that matches the elbilId
...
//# sourceMappingURL=elbil.js.8962b4c7a2de77577953.hot-update.js.map