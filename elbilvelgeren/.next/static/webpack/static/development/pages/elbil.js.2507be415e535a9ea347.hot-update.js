...
function ElbilDetail(_ref3) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_4__["useEffect"])(function () {
    var articleTitle = _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(data.labrador.article.title); // returned function will be called on component unmount 
  ...
  console.log(data.labrador.article.title);
  console.log(data.labrador.article.bodytextHTML);
  console.log(data.labrador.article.imageId); // Filtering out the car that matches the elbilId
...
//# sourceMappingURL=elbil.js.2507be415e535a9ea347.hot-update.js.map