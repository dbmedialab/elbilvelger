...
function ElbilDetail(_ref3) {
  ...
  var bodyTitle = _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(data.labrador.article.title);

  var bodyText = _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(data.labrador.article.bodytextHTML); // Filtering out all the Cars that does not match the id 
  ...
  var elBiler = elbilDetail.map(function (elbil) {
    return __jsx(react_reveal_Fade__WEBPACK_IMPORTED_MODULE_10___default.a, {
      ...
      __self: this
    }, "Sitteplasser: ", elbil.sitteplasser), bodyText));
  });
...
//# sourceMappingURL=elbil.js.e9e9ae63b6c33e09d956.hot-update.js.map