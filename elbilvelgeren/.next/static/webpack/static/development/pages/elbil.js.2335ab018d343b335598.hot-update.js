...
function ElbilDetail(_ref) {
  ...
  var elbilDetail = _elbiler_json__WEBPACK_IMPORTED_MODULE_9__.filter(function (elbil) {
    return elbil.id === _this.state.elbilId;
  ...
  var elBiler = elbilDetail.map(function (elbil) {
    return __jsx(react_reveal_Fade__WEBPACK_IMPORTED_MODULE_10___default.a, {
      ...
      __self: this
    }, elbil.tester), _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_2___default()({
      data: data
    })));
  });
}
...
//# sourceMappingURL=elbil.js.2335ab018d343b335598.hot-update.js.map