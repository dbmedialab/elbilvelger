...
function () {
  ...
  _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee(_ref) {
    var req, url, parameter, elbilId, data, elbilDetail;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            data = Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_2__["default"])(_elbiler_json__WEBPACK_IMPORTED_MODULE_10__);
            console.log(data); // Filtering out all the Cars that does not match the id 

            elbilDetail = data.filter(function (elbil) {
              return elbil.id === elbilId;
            });
            return _context.abrupt("return", {
              elbilId: elbilId,
              elbilDetail: elbilDetail
            });
...
function ElbilDetail(_ref3) {
  ...
  var articleData = _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(data); // Mapping the id that remains after filtering
...
//# sourceMappingURL=elbil.js.f12b059c1571ca2741cf.hot-update.js.map